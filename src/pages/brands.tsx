                                ...
                                <div className="py-0">
                                    <div className="bg-white shadow-[0_2px_8px_rgb(0,0,0,0.1)] rounded-lg p-7 ">
                                        <div>
                                            <div className="flex items-center justify-between py-4">
                                                <div className="flex flex-1 justify-start items-center">
                                                    <h1 className=' text-[#F12D4D] text-2xl mr-8 font-semibold'>Brands</h1>
                                                ...
                                                <div className="flex-1 flex items-end justify-end">
                                                    <Link href={`/inventory/product-list`}><button className="flex items-center justify-center mr-4 px-5 py-2 bg-[#F12D4D] rounded-md text-white font-semibold">
                                                        <AiOutlinePlus className="mr-2" /> Add Brands</button></Link>
                                                    {/* <Popover>
                                        ...
                                        <div className="flex flex-col justify-between min-h-[76vh] relative">
                                            <table className=" mt-10 min-w-full bg-white border rounded-md border-gray-200">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th className="py-2 px-4 bg-gray-100 border-b text-left">Brand Name</th>
                                                        <th className="py-2 px-4 bg-gray-100 border-b text-left">Category</th>
                                                        <th className="py-2 px-4 bg-gray-100 border-b text-left">Sub Category</th>
                                            ...
                                            {data?.products && data?.products?.length < 1 && <div className="w-full flex items-center justify-center absolute top-1/4">No Brands Found</div>}
                                        </div>
                                        <div className="flex items-center justify-between py-4">
                                            <div>
