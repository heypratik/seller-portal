...
function ShippingZoneSelector({ accountData }: { accountData: any }) {
    ...
    const [shippingZone, setShippingZone] = useState<any>([
        { "id": "26cbbd1d-a956-4ee9-975c-558710e680ff", "shippingZoneName": "TEST", "countries": { "Europe": ["Albania", "Andorra", "Austria", "Belarus", "Belgium", "Bosnia and Herzegovina", "Bulgaria", "Croatia", "Czech Republic", "Denmark", "England", "Estonia", "Faroe Islands", "Finland", "France", "Germany", "Gibraltar", "Greece", "Holy See (Vatican City State)", "Hungary", "Iceland", "Ireland", "Italy", "Latvia", "Liechtenstein", "Lithuania", "Luxembourg", "North Macedonia", "Malta", "Moldova", "Monaco", "Montenegro", "Netherlands", "Northern Ireland", "Norway", "Poland", "Portugal", "Romania", "Russian Federation", "San Marino", "Scotland", "Serbia", "Slovakia", "Slovenia", "Spain", "Svalbard and Jan Mayen", "Sweden", "Switzerland", "Ukraine", "United Kingdom", "Wales"] }, "rates": [] }, { "id": "26zdcd1d-5fs6-4ee9-975c-558710e680ff", "shippingZoneName": "TASEST", "countries": { "Asia": ["India"] }, "rates": [] }
    ]);
