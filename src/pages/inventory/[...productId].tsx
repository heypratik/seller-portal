                ...
                <div className="mx-auto px-4 sm:px-6 md:px-8 pb-24">
                    ...
                    <div className="py-4">
                        <form onSubmit={formik.handleSubmit} >
                            <div className="bg-white shadow-[0_2px_8px_rgb(0,0,0,0.1)] rounded-lg p-7 min-h-screen">
                                {productData?.success ? (
                                    <>
                                        ...
                                        <div className='flex w-full h-full'>
                                            <div className='flex-1'>
                                                ...
                                                <select {...formik.getFieldProps('productCategory')} name="productCategory" id="productCategory" className='mt-4 outline-none focus:outline-none border-brand-border rounded bg-[#f7f9fa] text-brand-text px-5 py-4 w-[470px]'>
                                                    ...
                                                    <option value="French">Category 2</option>
                                                    <option value="Japanese">Category 3</option>
                                                </select>
                                    ...
                                    <div className='flex items-center justify-center font-semibold'>No Product Found or Something went wrong.</div>
                                )}
                            </div>
                        </form>
                    </div>
